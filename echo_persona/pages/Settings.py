...
volc_ak = st.text_input("Volc Engine Access Key", value=st.session_state.volc_ak, type="password")

volc_sk = st.text_input("Volc Engine Secret Key", value=st.session_state.volc_sk, type="password")
